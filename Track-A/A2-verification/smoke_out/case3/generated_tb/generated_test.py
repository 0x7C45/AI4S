...
DUT: axi_vfifo_raw_rd
Clock: clk, Reset: rst (high active)
Protocols: AXI, SRAM, valid-ready
...
async def run_generated_test(dut):
    ...
    coverage = None
    if _HAS_FC:
        coverage = FunctionalCoverage("axi_vfifo_raw_rd", {"adapter_path": ["width_conversion", "merge_master_beats", "narrow_size_read", "partial_last_beat"], "address_alignment": ["aligned_4_byte", "aligned_2_byte", "unaligned", "near_4k_boundary"], "address_boundary": ["addr_zero", "addr_max", "addr_mid"], "backpressure": ["source_rready_pause", "downstream_arready_pause", "downstream_rvalid_pause", "combined_pause"], "burst_size": ["size_1_byte", "size_2_byte", "size_4_byte", "default_max_size"], "concurrent_access": ["simultaneous_rw", "sequential_rw"], "data_alignment": ["byte_aligned", "halfword_aligned", "word_aligned", "unaligned"], "data_width_boundary": ["min_width", "half_width", "full_width", "over_width"], "fifo_full_empty": ["fifo_empty_read", "fifo_full_write", "fifo_half"], "overflow_underflow": ["no_overflow", "overflow", "underflow"], "read_after_write": ["raw_same_addr", "raw_diff_addr"], "read_length": ["1", "2_to_3", "4", "5_to_15", "16_to_31", "32_to_63", "64_to_127", "128_to_256"], "sign_extension": ["positive_extend", "negative_extend", "zero_extend"], "write_after_read": ["war_same_addr", "war_diff_addr"]})
